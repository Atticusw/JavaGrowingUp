...
public class PolymorphismAppMainSimple {
    ...
    public static void main(String[] args) {
        ...
        LittleSuperMarket market = new LittleSuperMarket("大卖场", "杭州", 500, 600, 100);
        ...
        market.getMerchandiseOf(0).describe();
        System.out.println();
        market.getMerchandiseOf(10).describe();
        System.out.println();
        market.getMerchandiseOf(100).describe();
